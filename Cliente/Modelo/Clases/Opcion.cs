...
{
    // Clase que representa una opción de votación, con un identificador, nombre de la lista y nombre del candidato.
    public enum OpcionesDefault {
    Blanco,
    Nulo
    }
    // Esta clase define una opción de voto que puede ser seleccionada por un votante en una elección.
    public class Opcion
    {
